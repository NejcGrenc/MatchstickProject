var translationMap =
{
	'en': {
		...
		'm_acknowledgement' : 'By writing your name and pressing the green continue button, ' +
							  '<br /> you agree to the <a id=\"button-agreement\" href="javascript:terms();">terms and conditions</a> of the study.'
	},
	'si': {
	...
	'sk': {
		'm_welcome': 'Vitajte',
		'm_nameInput': 'Napíšte Vaše meno',
		'm_repeatedLogin': "Ste prihlásený po prvýkrát?",
		'm_acknowledgement' : 'Napísaním Vášho mena a kliknutím na zelené tlačidlo Pokračovať,' +
							  '<br /> Súhlasíte so zúčastnením na tejto štúdií.' +
							  '<br /> Dovoľujete zhromaždiť a uchovať anonymné osobné údaje a údaje viazané k úlohám, t.j. všetky aktivity a čas strávený pri úlohách, pre ich použitie v tejto štúdií.' +
							  '<br /> Taktiež súhlasíte s použitím cookies.'
	}
}
